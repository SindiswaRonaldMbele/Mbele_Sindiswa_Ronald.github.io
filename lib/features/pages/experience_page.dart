          ...
          child: ConstrainedBox(
            ...
            child: AnimatedPage(
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Text('Experience', style: theme.textTheme.displaySmall),
                const SizedBox(height: 8),
                const Text('Dedicated screen for Experience. This is not part of a long one-page layout.'),
                const SizedBox(height: 24),
                Card(child: Padding(padding: const EdgeInsets.all(22), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Text('Experience overview', style: theme.textTheme.titleLarge), const SizedBox(height: 8), const Text('Add and expand content here as your portfolio grows.')]))),
